...
class _EditProdcutScreenState extends State<EditProdcutScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title:
            Text(_initValues['title'] == '' ? 'Add Prodcut' : 'Edit Prodcut'),
        actions: [
          IconButton(
                    ...
                    TextFormField(
                      ...
                      validator: (value) {
                        ...
                        if (double.parse(value) <= 0) {
                          return 'Please enter a price bigger than 0.0!';
                        }
                        return null;
                      },
                      onSaved: (value) {
                          ...
                          child: TextFormField(
                            ...
                            validator: (value) {
                              ...
                              if (!value.startsWith('http') &&
                                ...
                                return 'Should be submit a valid URL!';
                              }
                              if (!value.endsWith('.png') &&
                                  !value.endsWith('.jpg') &&
                                  !value.endsWith('.jpeg')) {
                                return 'Should be submit a valid image URL!';
                              }
                              return null;
                            },
                            onSaved: (value) {
